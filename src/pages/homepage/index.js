...
import { PROYECTOSDesktop, SERVICIOSDesktop, PROYECTOSMobile, SERVICIOSMobile } from "../../assets";
...
function HomePage() {
  ...
  const formik = useFormik({
    ...
    onSubmit(values, {setSubmitting, setErrors, setStatus, resetForm}) {
        ...
        axios.post('https://protected-spire-89566.herokuapp.com/sendmail',
        formData,
        {
        ...
        setTimeout(function(){
          NotificationManager.success('Success message', 'This mail is sent correctly');
        },1000)
      }
  })
  ...
  const handleResize = (e) => {
    if(window.innerWidth < 400){
      setState({...state, PROYECTO: PROYECTOSMobile, SERVICIOS: SERVICIOSMobile});
    }
    else{
      setState({...state, PROYECTO: PROYECTOSDesktop, SERVICIOS: SERVICIOSDesktop});
    }
  }
  ...
  useEffect(() => {
    ...
    fakeRequest().then(() => {
      ...
      el.remove();
      if (width < 400) {
        setState({...state, isLoading: false, PROYECTO: PROYECTOSMobile, SERVICIOS: SERVICIOSMobile});
      }
      else{
        setState({...state, isLoading: false, PROYECTO: PROYECTOSDesktop, SERVICIOS: SERVICIOSDesktop});
      }
    });
  }, []);
            ...
            <ContainerBody>
              ...
              <FirstBlock>
                <Content>
                  ...
                  <Description>
                    En CONEMA nos hemos comprometido con la calidad y el cumplimiento a tiempo de 
                    todas las obras en las que hemos trabajado. Veinte años de experiencia de cada 
                    uno de nuestros ingenieros y técnicos respaldan este compromiso.
                  </Description>
                    ...
                    <ScrollAnimation animateIn="fadeIn">
                      ...
                      <CarouselDiv>
                        ...
                        <div>
                          ...
                          <CarouselDivContent>
                            Contamos con la experiencia necesaria para cumplir con las necesidades de tus proyectos, equilibrando la variable CALIDAD-COSTO.
                          </CarouselDivContent>
                        </div>
                      </CarouselDiv>
                    </ScrollAnimation>
        ...
        <BackGround>
          ...
          <ContainerBody>
                ...
                <SecondBlockCover>
                  <ScrollAnimation animateIn="fadeIn">
                    ...
                    <CarouselDiv>
                      ...
                      <div>
                        <CarouselDivContent>
                        Cada proyecto es una experiencia única para nuestro equipo de ingenieros y técnicos, 
                        en CONEMA brindamos un servicio de excelencia, contamos con mano de obra calificada y competitiva innovando 
                        en nuestros procesos de ingeniería.
                        </CarouselDivContent>
                      </div>
                    </CarouselDiv>
                  </ScrollAnimation>
                ...
                <ContactForm>
                  <ContactFormDescription>
                      <ContactFormItem style={{display: 'flex', margin: 'auto'}}>
                        ...
                        <div className="contactIcon" style={{width: "5%", marginRight: "30px"}}>
                          <a href="https://maps.app.goo.gl/sziFGF85Ju1QVYF49">
                            <MapsIcon className="rotate"/>
                          </a>
                        </div>
                        <div style={{ width: '300px', marginRight: "30px"}} className="contactDescirption">
                          <div>
                            Col. Progreso Nacional, 
                          </div>
                          <div>
                      ...
                      <ContactFormItem style={{ marginTop: "30px"}}>
                        ...
                        <div style={{ width: '300px', marginRight: "30px"}} className="contactDescirptionphone">
                    ...
                    <form onSubmit={formik.handleSubmit} style={{display: 'flex', flexDirection: 'column'}}>
                      <div style={{display: 'flex', justifyContent:'space-between', padding: '10px'}}>
                        ...
                        <button type="submit" className="sendBtn">
                          <div style={{fontFamily: 'DINAlternate-Bold', fontSize: '30px', color: '#ffffff', margin: 'auto'}}>
                            enviar
                          </div>
              ...
              <ScrollAnimation animateIn="fadeIn">
                <ul>
                  <li>
                    <a href="http://linkedin.com/in/operaciones-conema-40a97b1bb"><i className="fab fa-linkedin-in icon"></i></a></li>
                  <li>
                  ...
                  <li>
                    <a href="https://twitter.com/AmxConem"><i className="fab fa-twitter icon"></i></a>
                  </li>
                  <li>
                    <a href="https://www.instagram.com/invites/contact/?i=1lkgw3y8erjdt&utm_content=kj84l1g"><i className="fab fa-instagram icon"></i></a>
                  </li>
                  <li>
                    <a href="https://www.youtube.com/channel/UC7d9_QAwMQm0TOHbbXFFbQA"><i className="fab fa-youtube icon"></i></a></li>
                </ul>
              </ScrollAnimation>

              <Footer>
                <div style={{width: "100%", height: "100%", alignItems:"flex-end", margin: "80px 50px 20px 50px", display: 'flex', justifyContent: "space-between" }}>
                  <div style={{width: "15vw", display: 'flex', height: '100%', alignItems:"flex-end"}}>
                    <div style={{width: "2vw"}}>
                      <FooterRay />
                    </div>
